...
def check_play_button(ai_settings, screen, stats, sb, aliens, bullets, ship,
...
def check_events(ai_settings, stats, sb, aliens, screen, ship, bullets,
                 play_button):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, stats, sb, aliens,
                              bullets, ship, play_button, mouse_x, mouse_y)
